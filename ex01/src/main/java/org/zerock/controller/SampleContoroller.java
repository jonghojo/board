...
//	@RequestMapping(value = "/sample/", method = RequestMethod.GET)
	...
	@GetMapping("/ex02") // 매개변수 기본 자료로 값 전달
//	public String ex02(String name, int age) {
	...
	@GetMapping("/ex02List")
	public String ex02List(@RequestParam("ids")ArrayList<String> ids) {//ids라는 배열이 존재하지않으므로 에러페이지로 빠진다
...
//	@ModelAttribute --> 클라이언트가 보낸 내용을 바로 뷰로 전송
	@GetMapping("/ex04")
